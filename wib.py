...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='TOKEN MU BRO MASUKIN SINI')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='TOKEN MU BRO MASUKIN SINI')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='TOKEN MU BRO MASUK SINI')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='TOKEN MU BRO MASUK SINI')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='TOKEN MU BRO MASUK SINI')
kr.loginResult()
print "Kr-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='TOKEN MU BRO MASUK SINI')
km.loginResult()
